    ...
    <div>
      ...
      <details>
        ...
        <div style={{ marginTop: 10, fontSize: 13, lineHeight: 1.8 }}>
          ...
          <p><strong>Why B×A differs in size:</strong> B is 3×2, A is 2×3. B's columns (2) = A's rows (2) ✓, so B×A IS valid too — but the result size follows B's rows × A's columns = 3×3, completely different from A×B's 2×2 result. Same matrices, different order, different output size entirely.</p>
        </div>
      </details>
    </div>
  ),
    ...
    <div>
      ...
      <details>
        ...
        <div style={{ marginTop: 10, fontSize: 13, lineHeight: 1.8 }}>
          ...
          <p><strong>Observation:</strong> A×I = I×A = A — the identity matrix is the one special case where order doesn't matter, since it acts exactly like the number 1 does in regular multiplication.</p>
