        ...
        {courses.map((course) => (
          ...
          >
            ...
            <div style={{ padding: '20px 20px 18px' }}>
              <p style={{ fontSize: 26, margin: '0 0 4px', lineHeight: 1 }}>{emojiFor(String(course.title || ''))}</p>
              <p style={{ fontSize: 15, fontWeight: 800, margin: '4px 0 5px', color: 'var(--foreground)', lineHeight: 1.3, position: 'relative' }}>
                {course.title}
              </p>
              <p style={{ fontSize: 10.5, fontWeight: 800, letterSpacing: '0.12em', textTransform: 'uppercase', margin: '0 0 16px', color: 'var(--accent-2, var(--accent))', position: 'relative' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14, position: 'relative' }}>
                ...
                <p style={{ fontSize: 11, fontWeight: 700, opacity: 0.65, margin: 0 }}>Grade: —</p>
              </div>
